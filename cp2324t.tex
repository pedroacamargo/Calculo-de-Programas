...
\\
\>[B]{}\Varid{step}\;\Varid{l}\mathrel{=}\Varid{aux}\;\Varid{m}\;\Varid{l}{}\<[E]%
\\
\>[B]{}\hsindent{9}{}\<[9]%
\>[9]{}\mathbf{where}{}\<[E]%
\\
\>[9]{}\hsindent{2}{}\<[11]%
\>[11]{}\Varid{m}\mathrel{=}\Varid{maximumBy}\;(\Varid{comparing}\;(\p1\comp \p2))\;\Varid{l}{}\<[E]%
\\
\>[9]{}\hsindent{2}{}\<[11]%
\>[11]{}\Varid{aux}\;\anonymous \;[\mskip1.5mu \mskip1.5mu]\mathrel{=}[\mskip1.5mu \mskip1.5mu]{}\<[E]%
\\
\>[9]{}\hsindent{2}{}\<[11]%
\>[11]{}\Varid{aux}\;(\Varid{pm},(\Varid{vm},\Varid{dm}))\;((\Varid{p},(\Varid{v},\Varid{d}))\mathbin{:}\Varid{as}){}\<[E]%
\\
\>[11]{}\hsindent{2}{}\<[13]%
\>[13]{}\mid \Varid{pm}\equiv \Varid{p}\mathrel{\wedge}\Varid{dm}\equiv \mathrm{0}\mathrel{=}(\Varid{p},(\Varid{v}\mathbin{\Varid{`div`}}\mathrm{2},\succ \;\Varid{d}))\mathbin{:}\Varid{aux}\;(\Varid{pm},(\Varid{vm},\Varid{dm}))\;\Varid{as}{}\<[E]%
\\
\>[11]{}\hsindent{2}{}\<[13]%
\>[13]{}\mid \Varid{pm}\equiv \Varid{p}\mathrel{=}(\Varid{p},((\Varid{v}\mathbin{*}(\Varid{d}\mathbin{+}\mathrm{1}))\mathbin{\Varid{`div`}}(\Varid{d}\mathbin{+}\mathrm{2}),\succ \;\Varid{d}))\mathbin{:}\Varid{aux}\;(\Varid{pm},(\Varid{vm},\Varid{dm}))\;\Varid{as}{}\<[E]%
\\
\>[11]{}\hsindent{2}{}\<[13]%
\>[13]{}\mid \Varid{otherwise}\mathrel{=}(\Varid{p},(\Varid{v},\Varid{d}))\mathbin{:}\Varid{aux}\;(\Varid{pm},(\Varid{vm},\Varid{dm}))\;\Varid{as}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
