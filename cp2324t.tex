...
\column{17}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{m}\;[\mskip1.5mu \mskip1.5mu]\mathrel{=}i_1\;(){}\<[E]%
\\
\>[B]{}\Varid{m}\;\Varid{x}\mathrel{=}i_2\;(\Varid{x},\Varid{tail}\;\Varid{x}){}\<[E]%
\\[\blanklineskip]%
...
\\[\blanklineskip]%
\>[B]{}\Varid{gmax}\mathrel{=}\alt{\underline{\mathrm{0}}}{\Varid{umax}}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{n}\mathrel{=}\Varid{gmax}\comp \Varid{baseList}\;\Varid{lR}\;\Varid{id}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{lrh}\mathrel{=}\hyloList{\Varid{n}}{\Varid{m}}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
