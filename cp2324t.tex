...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{waste}\mathrel{=}\Varid{sum}\;(\map \;(\p1\comp \p2)\;\Varid{last}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\xymatrix@C=2cm{
    \ensuremath{\Conid{A}\mathbin{*}}
           ...
           \ar[d]_-{[(lsplit)]}
&
    \ensuremath{\Conid{Int}\mathbin{+}({\LTree}\;\Conid{Int}\mathbin{*})\times({\LTree}\;\Conid{Int}\mathbin{*})}
           \ar[d]^-{\ensuremath{\Varid{id}\mathbin{+}\Varid{lsplit}\times\Varid{lsplit}}}
        %    \ar@@/^/[l]^-{\mathsf{in}}
\\
    \ensuremath{\Conid{Int}}
        \ar@/^/[r]^-{\mathsf{out}}
        \ar[d]_-{(\ensuremath{[\mskip1.5mu \Varid{singl},\Varid{merge}\mskip1.5mu]})}
&
    \ensuremath{\Conid{Int}\mathbin{+}({\LTree}\;\Conid{Int}\mathbin{*})\times({\LTree}\;\Conid{Int}\mathbin{*})}
           \ar@/^/[l]^-{\mathsf{[Leaf, Fork]}}
           \ar[d]^-{\ensuremath{\Varid{id}\mathbin{+}[\mskip1.5mu \Varid{singl},\Varid{merge}\mskip1.5mu]\times[\mskip1.5mu \Varid{singl},\Varid{merge}\mskip1.5mu]}}
\\
    \ensuremath{\Conid{B}\mathbin{*}}
&
    \ensuremath{\Conid{Int}\mathbin{+}({\LTree}\;\Conid{Int}\times{\LTree}\;\Conid{Int})}
...
\xymatrix@C=2cm{
    \ensuremath{\Conid{A}\mathbin{*}}
           ...
           \ar[d]_-{[(splitK)]}
&
    \ensuremath{\Conid{Int}\mathbin{+}({\LTree}\;\Conid{Int}\mathbin{*})\mathbin{*}}
           \ar[d]^-{\ensuremath{\Varid{id}\mathbin{+}\Varid{splitK}\mathbin{*}}}
\\
    \ensuremath{\Conid{Int}}
        \ar@/^/[r]^-{\mathsf{out}}
        \ar[d]_-{(\ensuremath{[\mskip1.5mu \Varid{singl},\Varid{mergek}\mskip1.5mu]})}
&
    \ensuremath{\Conid{Int}\mathbin{+}({\LTree}\;\Conid{Int}\mathbin{*})\mathbin{*}}
           \ar@/^/[l]^-{\mathsf{in}}
           \ar[d]^-{\ensuremath{\Varid{id}\mathbin{+}[\mskip1.5mu \Varid{singl},\Varid{mergek}\mskip1.5mu]\mathbin{*}}}
\\
    \ensuremath{\Conid{B}\mathbin{*}}
&
    \ensuremath{\Conid{Int}\mathbin{+}({\LTree}\;\Conid{Int}\mathbin{*})\mathbin{*}}
...
\>[B]{}\Varid{mergek}\mathrel{=}\hyloList{\Varid{f}}{\Varid{g}}{}\<[E]%
\\
\>[B]{}\Varid{f}\mathrel{=}\Varid{splitK}{}\<[E]%
\\
\>[B]{}\Varid{g}\mathrel{=}[\mskip1.5mu \Varid{singl},\Varid{mergek}\mskip1.5mu]{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{loop}\;(\Varid{a},\Varid{b})\mathrel{=}(\Varid{a}\mathbin{+}\mathrm{1},\Varid{b}\mathbin{*}((\mathrm{4}\mathbin{*}\Varid{a})\mathbin{-}\mathrm{2})\mathbin{:}\Varid{a}\mathbin{+}\mathrm{1}){}\<[E]%
\\
