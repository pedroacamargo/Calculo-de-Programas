...
\\
\>[11]{}\hsindent{2}{}\<[13]%
\>[13]{}\mid \Varid{maxP}\equiv \Varid{p}\mathrel{\wedge}\Varid{maxD}\equiv \mathrm{0}\mathrel{=}(\Varid{p},(\Varid{v}\mathbin{\Varid{`div`}}\mathrm{2},\succ \;\Varid{d}))\mathbin{:}\Varid{rest}{}\<[E]%
\\
\>[11]{}\hsindent{2}{}\<[13]%
\>[13]{}\mid \Varid{maxP}\equiv \Varid{p}\mathrel{=}(\Varid{p},((\Varid{v}\mathbin{*}\succ \;\Varid{d})\mathbin{\Varid{`div`}}(\Varid{d}\mathbin{+}\mathrm{2}),\succ \;\Varid{d}))\mathbin{:}\Varid{rest}{}\<[E]%
\\
\>[11]{}\hsindent{2}{}\<[13]%
...
\xymatrix@C=3cm{
    (A^{*})^{*}
           ...
           \ar[d]_-{mergeK}
&
    1 + A \ensuremath{\times} (A^{*})^{*}
           \ar[d]^-{id + id \ensuremath{\times} mergeK}
\\
    A^{*}
&
    1 + A \ensuremath{\times} A^{*}
...
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mid \Varid{otherwise}\mathrel{=}\mathbf{let}\;\Varid{chunks}\mathrel{=}\Varid{chunksOf}\;(\mathbf{if}\;\length \;\Varid{l}\leq \Varid{k}\;\mathbf{then}\;\mathrm{1}\;\mathbf{else}\;\Varid{k})\;\Varid{l}{}\<[E]%
\\
\>[5]{}\hsindent{12}{}\<[17]%
...
&
    1 + A^{*} \ensuremath{\times} A^{*}
           \ar[d]^-{id + id \ensuremath{\times} subL}
\\
    (A^{*})^{*}
        \ar@/^/[r]^-{\mathsf{out}}
        \ar[d]_-{(\ensuremath{[\mskip1.5mu \Varid{maximum}\comp \map \;\Varid{lR}\mskip1.5mu]})}
&
    1 + A^{*} \ensuremath{\times} (A^{*})^{*}
           \ar@/^/[l]^-{\mathsf{in = [nil, concat]}}
           \ar[d]^-{id + id \ensuremath{\times} (\ensuremath{\Varid{maximum}\comp \map \;\Varid{lR}})}
\\
    A
&
    1 + A^{*} \ensuremath{\times} A
...
\column{17}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{lrh}\mathrel{=}(\Varid{maximum}\comp \map \;\Varid{lR})\comp \Varid{subL}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{subL}\;[\mskip1.5mu \mskip1.5mu]\mathrel{=}[\mskip1.5mu \mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{subL}\;\Varid{xs}\mathrel{=}\Varid{xs}\mathbin{:}\Varid{subL}\;(\Varid{tail}\;\Varid{xs}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{lR}\;[\mskip1.5mu \mskip1.5mu]\mathrel{=}\mathrm{0}{}\<[E]%
\\
\>[B]{}\Varid{lR}\;[\mskip1.5mu \Varid{x}\mskip1.5mu]\mathrel{=}\Varid{x}{}\<[E]%
\\
\>[B]{}\Varid{lR}\;(\Varid{x}\mathbin{:}\Varid{y}\mathbin{:}\Varid{xs}){}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mid \Varid{x}\mathbin{>}\Varid{y}{}\<[17]%
\>[17]{}\mathrel{=}\Varid{x}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mid \Varid{x}\leq \Varid{y}{}\<[17]%
\>[17]{}\mathrel{=}\Varid{x}\mathbin{+}\Varid{lR}\;(\Varid{x}\mathbin{:}\Varid{xs}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
